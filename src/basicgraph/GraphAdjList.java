...
public class GraphAdjList extends Graph {
	 ...
	 */		
	 public List<Integer> getDistance2(int v) {
		 ...
		 List<Integer> get2Neighbors = new ArrayList<Integer>();
		 List<Integer> neighbors = new ArrayList<Integer>(adjListsMap.get(v));
		 for(Integer vertex:neighbors) {
			 get2Neighbors.addAll(adjListsMap.get(vertex));
		 }
		 return get2Neighbors;
	 }
