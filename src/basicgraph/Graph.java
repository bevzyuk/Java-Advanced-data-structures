...
public abstract class Graph {
	...
	public static void main (String[] args) {
		GraphLoader.createIntersectionsFile("data/maps/kyiv.map", "data/intersections/kyiv.intersections");
